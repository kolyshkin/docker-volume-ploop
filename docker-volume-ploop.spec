...
%global commit         	ca4203016338aad917c39e879860a2ca3e4cda71
...
%install
%{__make} DESTDIR=%{buildroot} SYSTEMD_DIR=%{_unitdir} install
...
%files
%{_bindir}/docker-volume-ploop
%{_unitdir}/docker-volume-ploop.service
%{_unitdir}/docker-volume-ploop.socket
%config %{_sysconfdir}/sysconfig/docker-volume-ploop
